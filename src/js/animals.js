const animals = [
  ...
  [
    {
      c: '#E5FEFA',
      p: [ { x: 1280, y: 1065 }, { x: 1544, y: 1045 }, { x: 1537, y: 1078 } ]
    },
    {
      c: '#58ABA1',
      p: [ { x: 1537, y: 1078 }, { x: 1544, y: 1045 }, { x: 1623, y: 1048 } ]
    },
    {
      c: '#4C9B98',
      p: [ { x: 1623, y: 1048 }, { x: 1544, y: 1045 }, { x: 1603, y: 989 } ]
    },
    {
      c: '#3A8088',
      p: [ { x: 1603, y: 989 }, { x: 1623, y: 1048 }, { x: 1673, y: 988 } ]
    },
    {
      c: '#266979',
      p: [ { x: 1673, y: 988 }, { x: 1623, y: 1048 }, { x: 1699, y: 1008 } ]
    },
    {
      c: '#185769',
      p: [ { x: 1699, y: 1008 }, { x: 1623, y: 1048 }, { x: 1731, y: 1048 } ]
    },
    {
      c: '#216373',
      p: [ { x: 1731, y: 1048 }, { x: 1623, y: 1048 }, { x: 1673, y: 1151 } ]
    },
    {
      c: '#3B8689',
      p: [ { x: 1673, y: 1151 }, { x: 1623, y: 1048 }, { x: 1590, y: 1105 } ]
    },
    {
      c: '#2B8789',
      p: [ { x: 1590, y: 1105 }, { x: 1673, y: 1151 }, { x: 1642, y: 1279 } ]
    },
    {
      c: '#4B9596',
      p: [ { x: 1642, y: 1279 }, { x: 1590, y: 1105 }, { x: 1583, y: 1200 } ]
    },
    {
      c: '#5EB4A9',
      p: [ { x: 1583, y: 1200 }, { x: 1590, y: 1105 }, { x: 1537, y: 1078 } ]
    },
    {
      c: '#50A39B',
      p: [ { x: 1537, y: 1078 }, { x: 1590, y: 1105 }, { x: 1623, y: 1048 } ]
    },
    {
      c: '#A14339',
      p: [ { x: 1642, y: 1279 }, { x: 1673, y: 1151 }, { x: 1746, y: 1093 } ]
    },
    {
      c: '#B6613C',
      p: [ { x: 1746, y: 1093 }, { x: 1673, y: 1151 }, { x: 1731, y: 1048 } ]
    },
    {
      c: '#D08043',
      p: [ { x: 1731, y: 1048 }, { x: 1746, y: 1093 }, { x: 1857, y: 923 } ]
    },
    {
      c: '#DE9247',
      p: [ { x: 1857, y: 923 }, { x: 1746, y: 1093 }, { x: 1876, y: 1014 } ]
    },
    {
      c: '#EDA448',
      p: [ { x: 1876, y: 1014 }, { x: 1857, y: 923 }, { x: 2023, y: 994 } ]
    },
    {
      c: '#F9B44D',
      p: [ { x: 2023, y: 994 }, { x: 1857, y: 923 }, { x: 2038, y: 936 } ]
    },
    {
      c: '#FAB74E',
      p: [ { x: 2038, y: 936 }, { x: 1857, y: 923 }, { x: 2045, y: 852 } ]
    },
    {
      c: '#D68745',
      p: [ { x: 2023, y: 994 }, { x: 1876, y: 1014 }, { x: 1993, y: 1060 } ]
    },
    {
      c: '#CB7C43',
      p: [ { x: 1993, y: 1060 }, { x: 1876, y: 1014 }, { x: 1928, y: 1151 } ]
    },
    {
      c: '#B9643F',
      p: [ { x: 1928, y: 1151 }, { x: 1876, y: 1014 }, { x: 1746, y: 1093 } ]
    },
    {
      c: '#AA4F3C',
      p: [ { x: 1746, y: 1093 }, { x: 1928, y: 1151 }, { x: 1813, y: 1248 } ]
    },
    {
      c: '#8C2834',
      p: [ { x: 1813, y: 1248 }, { x: 1746, y: 1093 }, { x: 1642, y: 1279 } ]
    },
    {
      c: '#87172F',
      p: [ { x: 1642, y: 1279 }, { x: 1813, y: 1248 }, { x: 1718, y: 1295 } ]
    },
    {
      c: '#6D002A',
      p: [ { x: 1718, y: 1295 }, { x: 1642, y: 1279 }, { x: 1642, y: 1348 } ]
    },
    {
      c: '#033B56',
      p: [ { x: 1813, y: 1248 }, { x: 1804, y: 1308 }, { x: 1718, y: 1295 } ]
    },
    {
      c: '#377D85',
      p: [ { x: 1718, y: 1295 }, { x: 1804, y: 1308 }, { x: 1642, y: 1348 } ]
    },
    {
      c: '#327880',
      p: [ { x: 1642, y: 1348 }, { x: 1804, y: 1308 }, { x: 1784, y: 1381 } ]
    },
    {
      c: '#4C9B98',
      p: [ { x: 1784, y: 1381 }, { x: 1642, y: 1348 }, { x: 1655, y: 1404 } ]
    },
    {
      c: '#2C707B',
      p: [ { x: 1784, y: 1381 }, { x: 1655, y: 1404 }, { x: 1706, y: 1504 } ]
    },
    {
      c: '#55A89E',
      p: [ { x: 1642, y: 1348 }, { x: 1655, y: 1404 }, { x: 1574, y: 1420 } ]
    },
    {
      c: '#65B9AC',
      p: [ { x: 1574, y: 1420 }, { x: 1655, y: 1404 }, { x: 1538, y: 1510 } ]
    },
    {
      c: '#3D878A',
      p: [ { x: 1538, y: 1510 }, { x: 1655, y: 1404 }, { x: 1706, y: 1504 } ]
    },
    {
      c: '#469494',
      p: [ { x: 1706, y: 1504 }, { x: 1538, y: 1510 }, { x: 1615, y: 1575 } ]
    },
    {
      c: '#54A39D',
      p: [ { x: 1615, y: 1575 }, { x: 1538, y: 1510 }, { x: 1524, y: 1615 } ]
    }
  ]
]
